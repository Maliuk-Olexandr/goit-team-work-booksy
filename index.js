import{a as T,A as D}from"./assets/vendor-ByBLavyA.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function e(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=e(n);fetch(n.href,a)}})();const d={mobMenu:document.querySelector(".mobile-menu"),body:document.body};let p=!1;const v=t=>{if(p)return;p=!0,d.mobMenu.classList.toggle("is-open",t),d.body.classList.toggle("no-scroll",t);const o=e=>{e.target===d.mobMenu&&(p=!1,d.mobMenu.removeEventListener("transitionend",o))};d.mobMenu.addEventListener("transitionend",o)};document.addEventListener("click",t=>{t.target.closest("[data-menu-open]")?v(!0):t.target.closest("[data-menu-close], .mobile-link")&&v(!1)});const _="https://books-backend.p.goit.global/books";async function g(t=""){try{const{data:o}=await T.get(_+t);return o}catch(o){throw console.error("Error fetching data:",o.message),o}}async function k(){return(await g("/category-list")).map(o=>o.list_name)}async function h(){return await g("/top-books")}async function w(t){return await g(`/category?category=${t}`)}async function L(t){return await g(`/${t}`)}async function P(){try{const t=await k(),o=await h(),e=await w(t[0]),s=e[0]._id;console.log("\x1B[32mtestAPI() start ------------\x1B[0m"),console.log("GetCategoryList():",t),console.log("getTopBooks():",o),console.log(`getBooksByCategory('${t[0]}'):`,e),console.log(`getBookByID("${s}"):`,await L(s)),console.log("\x1B[32mtestAPI() end ------------\x1B[0m")}catch(t){console.error("API test failed:",t)}}const N=document.querySelector(".gallery"),m=document.querySelector("#category-select"),i=document.querySelector(".btn-show-more"),O=document.querySelector(".visible-books"),H=document.querySelector(".total-books"),b=document.querySelector(".categories-list");let r=[],c=0;const Q=await k();U(Q);const R=await h();r=R.flatMap(({books:t})=>t);f();function U(t){m.innerHTML='<option selected value="All categories">All categories</option>',b.innerHTML='<li><button class="category-btn active-category" value="All categories">All categories</button></li>',t.forEach(o=>{const e=document.createElement("option");e.value=o,e.textContent=o,m.appendChild(e);const s=document.createElement("li");s.classList.add("category-item");const n=document.createElement("button");n.value=o,n.textContent=o,n.classList.add("category-btn"),s.appendChild(n),b.appendChild(s)})}async function B(t){m.value=t,b.querySelectorAll(".category-btn").forEach(o=>o.classList.toggle("active-category",o.value===t)),t==="All categories"?r=(await h()).flatMap(({books:e})=>e):r=await w(t),f()}m.addEventListener("change",t=>{const o=t.target.value;B(o)});b.addEventListener("click",t=>{if(t.target.tagName!=="BUTTON")return;const o=t.target.value;B(o)});i.addEventListener("click",()=>{c+=4,C(),i.blur()});function f(){i.classList.remove("btn-show-more-hidden"),c=W(),C(),c>=r.length&&i.classList.add("btn-show-more-hidden"),H.textContent=r.length}function C(){const t=r.slice(0,c);N.innerHTML=j(t),O.textContent=Math.min(c,r.length),i.disabled=!1,c>=r.length&&i.classList.add("btn-show-more-hidden")}function W(){return window.innerWidth<768?10:24}window.addEventListener("resize",()=>{f()});function j(t){return t.map(({title:o,author:e,book_image:s,price:n})=>`
  ...
  `).join("")}function Y(t,o){const e=G(o);t.querySelector(".modal-content").innerHTML=e}function G(t){const{bookId:o,bookPicture:e,bookTitle:s,bookAuthor:n,bookPrice:a,bookQuantity:l,details:I,shipping:F,returns:x}=t;return`      
          ...
          <div class="ac">
            ...
            <div class="ac-panel">
              <p class="ac-text">${x}</p>
      ...
      </div>`}const M="shopping_cart";function J(t,o){if(!t||o<=0)return console.warn("Wrong parameters, can't add to cart"),!1;const e=E(),s=e[t]||0;return e[t]=Number(s)+Number(o),V(e)}function K(t){if(!t)return 0;const o=E();return Number(o[t])||0}function E(){try{const t=localStorage.getItem(M);return t?JSON.parse(t):{}}catch(t){return console.error("Cart data getting error:",t),{}}}function V(t){try{return localStorage.setItem(M,JSON.stringify(t)),!0}catch(o){return console.error("Cart saving error:",o),!1}}const u={modalBooks:document.querySelector(".modal-books"),modalContacts:document.querySelector(".modal-contacts")};function S(t){if(!t){console.error("Modal reference is not found");return}t.escapeHandler&&(document.removeEventListener("keydown",t.escapeHandler),t.removeEventListener("click",y)),t.escapeHandler=o=>{o.key==="Escape"&&q(t)},document.addEventListener("keydown",t.escapeHandler),t.addEventListener("click",y),t.classList.add("is-open"),document.body.style.overflow="hidden"}function q(t){if(!t){console.error("Modal reference is not found");return}t.removeEventListener("click",y),document.removeEventListener("keydown",t.escapeHandler);const o=document.getElementById("bookModalActionForm");o&&(o.removeEventListener("submit",$),o.removeEventListener("click",A)),t.classList.remove("is-open"),document.body.style.overflow=""}function y(t){const o=t.currentTarget,s=o.querySelector(".modal_close-btn").contains(t.target),n=t.target===o;(s||n)&&q(o)}class z{constructor(o){this.form=document.getElementById(o),this.submitBtn=this.form.querySelector("#submitBtn"),this.form.addEventListener("submit",e=>{e.preventDefault(),this.handleSubmit()})}getFormData(){const o=new FormData(this.form),e={};for(let[s,n]of o.entries())e[s]=n.trim();return e}showSuccess(o){console.log(o)}resetForm(){this.form.reset()}async handleSubmit(){const o=this.getFormData();try{await this.submitForm(o),this.showSuccess("Your registration has been submitted."),this.resetForm()}catch(e){console.error("Form submission error:",e)}}async submitForm(o){console.log("Form data:",o)}}function X(t){S(u.modalContacts),new z("contactForm")}async function Z(t="660df41ba957e5c1ae0f519e"){try{const o=await L(t),e={bookId:o._id,bookPicture:o.book_image,bookTitle:o.title,bookAuthor:o.author,bookPrice:o.price,bookQuantity:1,details:o.details||`I Will Find You is a gripping thriller by the master of
                ...
                you through the process quickly and hassle-free.`};S(u.modalBooks),Y(u.modalBooks,e),new D(u.modalBooks.querySelector(".modal-books .accordion-container"),{showMultiple:!0,duration:400,collapse:!0});const s=document.getElementById("bookModalActionForm");if(!s){console.error("Form bookModalActionForm not found");return}s.addEventListener("submit",$),s.addEventListener("click",A)}catch(o){console.error("Error loading  with getBookByID:",o)}}function $(t){t.preventDefault(),nt()}function A(t){switch(t.target.dataset.action){case"decrease":tt(t.target);break;case"increase":ot(t.target);break;case"add-to-cart":et(t.target);break}}function tt(t){const o=t.closest("[data-min-quantity]"),e=o.querySelector(".quantity-input"),s=parseInt(o.dataset.minQuantity),n=parseInt(e.value);n>s&&(e.value=n-1)}function ot(t){const o=t.closest("[data-max-quantity]"),e=o.querySelector(".quantity-input"),s=parseInt(o.dataset.maxQuantity),n=parseInt(e.value);n<s&&(e.value=n+1)}function et(t){const o=t.closest("[data-book-id]"),e=o.dataset.bookId,s=parseInt(o.querySelector(".quantity-input").value);J(e,s),console.log(`Book with ID'${e}' in q-ty '${s}' added to Cart`),console.log(`Total ID'${e}' in Cart ${K(e)}`)}function nt(){console.log("Thanks for bying")}window.openBooksModal=Z;window.openContactsModal=X;P();
